...
class LinkingTaskApi extends Controller {
  ...
  def putRule(projectName: String, taskName: String) = Action { request => {
    ...
    request.body.asXml match {
      ...
      case None =>
        ErrorResult.requestError(BadUserInputException("Expecting text/xml request body"))
    }
  }}
  ...
  def putLinkSpec(projectName: String, taskName: String) = Action { request => {
    ...
    request.body.asXml match {
      ...
      case None => ErrorResult.requestError(BadUserInputException("Expecting text/xml request body"))
    }
  }}
