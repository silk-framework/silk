 ...
 */
case class Context[T <: TaskSpecification](project: Project, task: ProjectTask[T], path: String)
...
object Context {
   ...
   */
  def get[T <: TaskSpecification : ClassTag](projectName: String, taskName: String, path: String): Context[T] = {
