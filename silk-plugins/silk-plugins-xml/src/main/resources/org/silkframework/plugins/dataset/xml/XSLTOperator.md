...
If formatting semantics are relevant, the XSL Formatting Objects (**XSL-FO**) vocabulary must be considered and described. This is beyond the scope of this document. The focus of this documentation is on the transformation of XML data via XSL transformations.
