...
class MeetsMetricTest extends FlatSpec with Matchers {
  ...
  //Meets evaluation.
  "MeetsMetric test 1" should "return '0.0'" in {
    metric.evaluate("[2000-01-01T00:00:00, 2000-01-01T00:00:01)", "[2000-01-01T00:00:01, 2000-01-01T00:00:02)") should equal(0.0)
  }
}
