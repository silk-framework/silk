...
@Plugin(
  ...
  description = "Computes the relation \"isFinishedBy\" between two time periods or instants.")
case class IsFinishedByMetric(blockingParameter: Double = 1.0) extends SingleValueDistanceMeasure {
