...
class OldJsonSinkTest extends FlatSpec with Matchers {

  implicit val userContext: UserContext = UserContext.Empty
  implicit val prefixes: Prefixes = Prefixes.empty

  ignore should "write entities to json" in {
  ...
  ignore should "write entities to json using the first object as the root" in {
  ...
  ignore should "write entities with arrays to json" in {
  ...
  ignore should "write flat structures nested under root element" in {
  ...
  ignore should "write nested structures" in {
