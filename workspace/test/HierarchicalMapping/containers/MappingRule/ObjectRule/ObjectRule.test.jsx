...
import ObjectEntityRelation
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/components/ObjectMapping/ObjectEntityRelation';
import TargetProperty
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/components/TargetProperty';
import ObjectTypeRules
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/components/ObjectMapping/ObjectTypeRules';
import ObjectSourcePath
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/components/ObjectMapping/ObjectSourcePath';
import EditButton
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/elements/buttons/EditButton';
import CopyButton
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/elements/buttons/CopyButton';
import CloneButton
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/elements/buttons/CloneButton';
import DeleteButton
    from '../../../../../src/app/views/pages/MappingEditor/HierarchicalMapping/elements/buttons/DeleteButton';
