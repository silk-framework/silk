import getUriOperatorsRecursive from "../../../src/app/views/pages/MappingEditor/HierarchicalMapping/utils/getUriOperators";
...
describe("getUriOperators function", () => {
    ...
    it("should return array of functions, when operators have `inputs` property", () => {
        ...
        expect(
            getUriOperatorsRecursive({
                function: fn,
                inputs: [{ function: input1Fn }, { function: input2Fn }],
            })
        ).toEqual([input1Fn, input2Fn, fn]);
    });
        ...
        expect(
            getUriOperatorsRecursive({
                ...
                inputs: [
                    {
                        function: input1Fn,
                        inputs: [{ function: nestedFn }],
                    },
                    { function: input2Fn },
                ],
            })
        ).toEqual([nestedFn, input1Fn, input2Fn, fn]);
    });
});
