...
type DeprecatedPluginsProps =
  | { projectId: string; taskId?: never }
  | { projectId?: never; taskId: string };
...
export function DeprecatedPluginsWidget({
  projectId,
  taskId,
}: DeprecatedPluginsProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "workflow:saved",
      handleWorkflowSaved as EventListener,
    );
  ...
  function groupByPluginWithLinks(
    data: DeprecatedPluginsModel[],
  ): GroupedDataWithLinks[] {
