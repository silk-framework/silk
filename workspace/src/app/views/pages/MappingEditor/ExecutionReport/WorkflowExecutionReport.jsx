...
export default class WorkflowExecutionReport extends React.Component {
            ...
            <div className="mdl-grid mdl-grid--no-spacing">
                <div className="mdl-cell mdl-cell--2-col silk-report-sidebar">
                    ...
                    <Card className="silk-report-sidebar-tasks">
                        <CardTitle className="silk-report-sidebar-tasks-title">Tasks</CardTitle>
                ...
                <div className="mdl-cell mdl-cell--10-col">{this.renderReport(this.props.executionReport.nodeId)}</div>
            </div>
        );
    }
    ...
    renderTaskItem(report, index, warnings) {
        ...
        return (
            <li key={"report-" + index} className={classNames} onClick={() => this.setState({ selectedIndex: index })}>
                <span className="mdl-list__item-primary-content">
                    {report.label} {report.operation != null ? "(" + report.operation + ")" : ""}
                    {this.renderTaskDescription(warnings)}
                </span>
                <span className="mdl-list__item-secondary-content">{this.renderTaskIcon(warnings, report.error)}</span>
            </li>
        );
    }
