...
import { Radio } from "@eccenca/gui-elements/src/legacy-replacements";
import { RadioGroup, Tooltip } from "gui-elements-deprecated";
    ...
    renderRadioBox() {
        return (
            <FieldItem className={this.props.className}>
                ...
                >
                    <Radio name="single" value="single" label={this.renderSingleValue()} />
                    <Radio name="multiple" value="multiple" label={this.renderMultipleValues()} />
                </RadioGroup>
            </FieldItem>
        );
    }
