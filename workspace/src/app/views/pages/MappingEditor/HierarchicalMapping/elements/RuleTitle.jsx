...
import { MAPPING_RULE_TYPE_COMPLEX_URI, MAPPING_RULE_TYPE_ROOT, MAPPING_RULE_TYPE_URI } from "../utils/constants";
...
const RuleTitle = ({ rule, ...otherProps }) => {
    ...
    switch (rule.type) {
        case MAPPING_RULE_TYPE_ROOT:
            ...
            return uri ? <ThingName id={uri} {...otherProps} /> : <span>Mapping</span>;
        ...
        case MAPPING_RULE_TYPE_COMPLEX:
            ...
            return uri ? <ThingName id={uri} {...otherProps} /> : <NotAvailable />;
