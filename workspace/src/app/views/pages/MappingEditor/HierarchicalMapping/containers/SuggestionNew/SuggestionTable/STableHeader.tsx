...
export default function STableHeader({
    ...
    const swapButton = (header: ITableHeader) => {
        return (
            (context.vocabulariesAvailable || !context.isFromDataset) && (
                <Button
                    onClick={onSwap}
                        ...
                        <ToolbarSection>
                            ...
                            >
                                {checkAllFilterOptions.map((o) => (
                                    <MenuItem key={o.value} text={o.text} onClick={() => handleSort(o.value)} />
                                ))}
                            </ContextMenu>
                            <ColumnFilter
                ...
                {headers.map((header) => (
                    <TableHeader key={header.key}>
                        {header.key === "SWAP_BUTTON" ? (
                            ...
                            <Toolbar noWrap={true}>
                                <ToolbarSection canShrink={true}>{header.header}</ToolbarSection>
                                <ToolbarSection>
