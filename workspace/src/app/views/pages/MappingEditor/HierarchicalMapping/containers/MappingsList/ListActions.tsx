...
const openToBottomFn = () => {
    ...
    let toBottom = false;
    try {
        const floatButtonRect = document
            .querySelectorAll(".ecc-floatingactionlist button.mdl-button")[0]
            .getBoundingClientRect();
        const navHeaderRect = document
            .querySelectorAll(".ecc-silk-mapping__navheader div.eccgui-card")[0]
            .getBoundingClientRect();
