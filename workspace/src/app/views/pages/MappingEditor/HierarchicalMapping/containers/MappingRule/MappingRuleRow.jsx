            ...
            <div className="mdl-list__item-primary-content">
                <div className="ecc-silk-mapping__ruleitem-headline ecc-silk-mapping__ruleitem-info-targetstructure">
                    <ThingIcon
                        ...
                        message={statusMsg}
                    />
                    <div className="ecc-silk-mapping__ruleitem-label nodrag">
                        {ruleLabelData.displayLabel}
                    </div>
                    {ruleLabelData.uri && <div
                        className="ecc-silk-mapping__ruleitem-extraline ecc-silk-mapping__ruleitem-url nodrag">{ruleLabelData.uri}</div>}
                </div>
