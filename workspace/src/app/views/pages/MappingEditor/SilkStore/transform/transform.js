...
silkStore.subject("transform.task.rule.completions.targetTypes").subscribe(({ data, replySubject }) => {
    ...
    superagent
        .get(`${CONTEXT_PATH}/transform/tasks/${project}/${transformTask}/rule/${ruleId}/completions/targetTypes`)
        .query({
            term,
            maxResults,
        })
...
silkStore.subject("transform.task.rule.completions.valueTypes").subscribe(({ data, replySubject }) => {
    ...
    superagent
        .get(`${CONTEXT_PATH}/transform/tasks/${project}/${transformTask}/rule/${ruleId}/completions/valueTypes`)
        .query({
            term,
            maxResults,
        })
