...
import {addPathToReferenceEntitiesCache} from "../../../LinkingRuleEditor.requests";
...
export const PathNotInCacheModal = ({projectId, linkingTaskId, toTarget, path, onAddPath, onClose}: PathNotInCacheModalProps) => {
    ...
    >
        <Markdown>
        {
            `${t("RuleEditor.evaluation.PathNotInCacheModal.messagePartA")}\n\n- ${path}\n\n${t("RuleEditor.evaluation.PathNotInCacheModal.messagePartB")}`
        }
        </Markdown>
    </SimpleDialog>
}
