...
object DatasetCharacteristics {
  ...
  def attributesOnly(supportsMultipleTables: Boolean = false,
                     readOnly: Boolean = false,
                     supportsMultipleWrites: Boolean = false,
                     explicitSchema: Boolean = false): DatasetCharacteristics = {
    DatasetCharacteristics(supportsMultipleTables = supportsMultipleTables, readOnly = readOnly, supportsMultipleWrites = supportsMultipleWrites, explicitSchema = explicitSchema)
  }
