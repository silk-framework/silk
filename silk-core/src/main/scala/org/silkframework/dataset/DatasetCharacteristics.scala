...
object DatasetCharacteristics {
  ...
  def attributesOnly(supportsMultipleTables: Boolean = false, supportsMultipleWrites: Boolean = false): DatasetCharacteristics = {
    DatasetCharacteristics(supportsMultipleTables = supportsMultipleTables, supportsMultipleWrites = supportsMultipleWrites)
  }
