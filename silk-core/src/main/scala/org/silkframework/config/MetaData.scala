...
object MetaData {
  ...
  private val cleanEccencaCorporateMemoryIdentifierRegex = "datasetresource_[\\d]+_".r

  /**
    * Generates a nice label from an identifier.
    */
  def labelFromId(identifier: String): String = {
    val id = cleanEccencaCorporateMemoryIdentifier(identifier)
  ...
  /**
    ...
    */
  private def cleanEccencaCorporateMemoryIdentifier(id: String): String = {
    cleanEccencaCorporateMemoryIdentifierRegex.replaceAllIn(id, "")
  }
