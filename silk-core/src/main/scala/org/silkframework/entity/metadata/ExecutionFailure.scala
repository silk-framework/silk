...
object ExecutionFailure {
  ...
  /* messages */
  final val NOMSG: String = "The exception message was empty or incorrectly de/derialized."
  final val NOCLA: String = "The exception class does not exist or was incorrectly de/derialized."
