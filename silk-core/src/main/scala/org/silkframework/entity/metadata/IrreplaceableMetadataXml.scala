...
object IrreplaceableMetadataXml{
  ...
  def apply[Typ](node: Node, serializer: SerializationFormat[Typ, Node])(implicit typ: Class[Typ]): IrreplaceableMetadataXml[Typ] =
    new IrreplaceableMetadataXml[Typ](None, Option(node), "", serializer)(typ)

  def apply[Typ](ser: String, serializer: SerializationFormat[Typ, Node])(implicit typ: Class[Typ]): IrreplaceableMetadataXml[Typ] =
