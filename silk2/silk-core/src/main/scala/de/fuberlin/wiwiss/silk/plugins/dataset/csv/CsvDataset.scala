...
case class CsvDataset(file: Resource, properties: String, separator: String = ",", arraySeparator: String = "", prefix: String = "", uri: String = "", regexFilter: String = "") extends DatasetPlugin {
