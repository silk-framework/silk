...
case class XmlDataset(file: Resource, basePath: String = "", uriPrefix: String = "") extends DatasetPlugin {

  override def source: DataSource = new XmlSource(file, basePath, uriPrefix)
