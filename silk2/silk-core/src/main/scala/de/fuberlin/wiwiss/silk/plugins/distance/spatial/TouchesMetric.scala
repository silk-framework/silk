...
@Plugin(
  ...
  label = "Touches",
  description = "Computes the relation \"touches\" between two geometries. Author: Panayiotis Smeros (Department of Informatics & Telecommunications, National & Kapodistrian University of Athens)")
case class TouchesMetric() extends SimpleDistanceMeasure {

  override def evaluate(str1: String, str2: String, limit: Double): Double = {
    SpatialExtensionsUtils.evaluateRelation(str1, str2, limit, SpatialExtensionsUtils.Constants.TOUCHES)
  }
