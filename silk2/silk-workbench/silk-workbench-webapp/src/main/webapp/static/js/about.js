$(document).ready(function() {
	var $dialog = $('<div id="about_dialog"></div>')
		.html('<p>Silk Workbench, version 2.4.2</p>' +
    '<p>© 2009-2011</p>' +
    ...
    '<p style="margin-top:5px;">The icons were created by <a href="http://p.yusukekamiyamane.com/">Yusuke Kamiyamane</a> and are licensed under the <a href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0 license</a>.</p>')
		.dialog({
			autoOpen: false,
			title: 'About',
      width: 700,
