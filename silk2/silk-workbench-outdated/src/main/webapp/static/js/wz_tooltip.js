...
config. Opacity			= 70		// Integer between 0 and 100 - opacity of tooltip in percent
...
config. Width			= 270			// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
