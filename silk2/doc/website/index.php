...
<p>To learn how to use the <em>Silk - Link Specification Language</em>, which is used in all applications to specifiy the linkage rules, please read the <a href="http://www4.wiwiss.fu-berlin.de/bizer/silk/spec/">Specification</a>.</p>
...
<H2 id=history>Version History</H2>
    ...
    <p><table>
      ...
      <tr id="grey">
        <td>2.5.1</td>
        <td>Various improvements to the Workbench.</td>
        <td>2011-10-21</td>
      </tr>
      <tr >
        <td>2.5</td>
        <td>Added support for learning linkage rules.</td>
        <td>2011-10-03</td>
      </tr>
      <tr id="grey">
        <td>2.4.2</td>
        <td>SPARQL/Update output<br/>
Dump file input<br/>
Improved indexing<br/>
Many improvements to the Silk Workbench<br/></td>
        <td>2011-07-22</td>
      </tr>
      <tr >
        <td>2.4.1</td>
        <td>Introduces per-comparison thresholds.<br/>
New data transformations and distance measures including token-based distance measures.<br/>
Improved Silk Workbench.<br/></td>
        <td>2011-07-01</td>
      </tr>
	  <tr id="grey"> 
        <td>2.4</td>
...
<ul>
  <li><a href="http://www4.wiwiss.fu-berlin.de/bizer/silk/linkspecs/sider_drugbank_drugs.xml">Interlinking Drugs in Sider and Drugbank</a></li>
  <li><a href="http://www4.wiwiss.fu-berlin.de/bizer/silk/linkspecs/dbpedia_linkedgeodata_cities.xml">Interlinking cities in DBpedia and LinkedGeoData</a></li>
</ul>
...
<p>
<ul>
    <li>Robert Isele, Christian Bizer: <a href="http://www.wiwiss.fu-berlin.de/en/institute/pwo/bizer/research/publications/IseleBizer-Silk-Learning-OM2011.pdf">Learning Linkage Rules using Genetic Programming</a>. 6th International Workshop on Ontology Matching. Bonn, Germany, October 2011.</li>
