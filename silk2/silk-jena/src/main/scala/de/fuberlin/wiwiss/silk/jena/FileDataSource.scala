...
import de.fuberlin.wiwiss.silk.util.sparql.{SparqlAggregatePathsCollector, EntityRetriever}
 ...
 */
@StrategyAnnotation(id = "file", label = "RDF dump", description = "DataSource which retrieves all entities from an RDF file.")
