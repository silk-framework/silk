...
import de.fuberlin.wiwiss.silk.plugins.spatial.distance.OverlapsMetric;
...
class OverlapsMetricTest extends FlatSpec with Matchers {
  ...
  "OverlapsMetric test 1" should "return '0.0'" in {
    metric.evaluate("POLYGON ((0 0, 0 2, 2 2, 2 0, 0 0))", "POLYGON ((0 1, 0 3, 3 3, 3 1, 0 1))", 0.0) should equal(0.0)
  }
