...
import de.fuberlin.wiwiss.silk.plugins.temporal.distance.MeetsMetric;

/**
 * Tests the Meets Metric.
...
class MeetsMetricTest extends FlatSpec with Matchers {
  ...
  //Meets evaluation.
  "MeetsMetric test 1" should "return '1.0'" in {
    metric.evaluate("[2000-01-01T00:00:00, 2000-01-01T00:00:01)", "[2000-01-01T00:00:01, 2000-01-01T00:00:02)", 1.0) should equal(1.0)
  }
}
