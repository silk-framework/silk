...
import de.fuberlin.wiwiss.silk.plugins.temporal.distance.IsOverlappedByMetric;

/**
 * Tests the IsOverlappedBy Metric.
 * @author Panayiotis Smeros (Department of Informatics & Telecommunications, National & Kapodistrian University of Athens)
 */

@RunWith(classOf[JUnitRunner])
class IsOverlappedByMetricTest extends FlatSpec with Matchers {
