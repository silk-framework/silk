...
import de.fuberlin.wiwiss.silk.plugins.temporal.distance.MillisecsDistanceMetric;
...
class MillisecsDistanceMetricTest extends FlatSpec with Matchers {
  ...
  "MillisecsDistanceMetric test 2" should "return 'Set(List(0))'" in {
    metric.indexValue("1970-01-01T00:00:00", 1.0) should equal(Index.oneDim(Set(0)))
  }
}
