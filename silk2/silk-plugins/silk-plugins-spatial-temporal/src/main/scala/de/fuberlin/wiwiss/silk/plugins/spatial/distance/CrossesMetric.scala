...
@Plugin(
  ...
  label = "Crosses",
  description = "Computes the relation \"crosses\" between two geometries. Author: Panayiotis Smeros (Department of Informatics & Telecommunications, National & Kapodistrian University of Athens)")
case class CrossesMetric(blockingParameter: Double = 1.0) extends SimpleDistanceMeasure {
