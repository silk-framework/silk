...
import org.silkframework.rule.plugins.transformer.normalize.RemoveSpecialCharsTransformer
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers


class RemoveSpecialCharsTransformerTest extends AnyFlatSpec with Matchers {
