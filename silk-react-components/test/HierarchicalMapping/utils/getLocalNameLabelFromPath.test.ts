import {getLocalNameLabelFromPath} from "../../../src/HierarchicalMapping/containers/SuggestionNew/utils";
...
describe("getLocalNameLabelFromPath", () => {
    ...
    it("should get local name of the last path part", () => {
        expect(getLocalNameLabelFromPath("<http://path/noThis>/<http://path/andNotThis>/<http://path/butThis>")).toBe("butThis")
