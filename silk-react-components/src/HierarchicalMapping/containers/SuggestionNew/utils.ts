 ...
 */
export const filterRowsByColumnModifier = (filters: {[key: string]: string},
                                           selectedSources: Set<string>,
                                           rows: IPageSuggestion[],
                                           fromDataset: boolean): IPageSuggestion[] => {
 ...
 */
export const sortRows = (rows: IPageSuggestion[], sortDirections: ISortDirection, fromDataset: boolean): IPageSuggestion[] => {
