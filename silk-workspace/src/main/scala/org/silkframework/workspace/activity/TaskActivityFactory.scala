...
/**
  ...
  */
abstract class TaskActivityFactory[TaskType <: TaskSpecification : ClassTag, ActivityType <: HasValue : ClassTag] extends AnyPlugin with (ProjectTask[TaskType] => Activity[ActivityType#ValueType]) {
